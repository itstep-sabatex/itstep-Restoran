...
{
    public partial class RestorantContextOld : DbContext
    {
        public RestorantContextOld()
        {
        }

        public RestorantContextOld(DbContextOptions<RestorantContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer(Program.Configuration.GetSection("ConnectionStrings").GetSection("DefaultConnection").Value);
            }
        }
